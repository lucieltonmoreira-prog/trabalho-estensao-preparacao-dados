...
A coleta foi realizada via Google Forms e exportada para o Excel. Nesta etapa, o software serviu como a base de armazenamento inicial. O desafio era lidar com nomes de colunas extensos (perguntas completas do formulário) e dados brutos que precisavam de padronização antes da análise.
